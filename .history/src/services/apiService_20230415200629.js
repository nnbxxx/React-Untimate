...
const postCreateNewQuiz = (description, name, difficulty, quizImage) => {
  "🚀 ~ file: apiService.js:45 ~ postCreateNewQuiz ~ difficulty:", difficulty;
  "🚀 ~ file: apiService.js:45 ~ postCreateNewQuiz ~ name:", name;
  "🚀 ~ file: apiService.js:45 ~ postCreateNewQuiz ~ description:", description;
  const data = new FormData();
